...
import {
  ...
  PiggyBank, Moon, Leaf, Code2, Bot, Users, FileBarChart, ShieldCheck, Percent
} from "lucide-react";
...
const sections: Section[] = [
  {
    items: [
      ...
      { href: "/admin/commissions",  key: "navCommissions",  icon: Percent },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/assurance",  key: "navAssurance",  icon: ShieldCheck },
